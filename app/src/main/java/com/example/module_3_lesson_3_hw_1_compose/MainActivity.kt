package com.example.module_3_lesson_3_hw_1_compose
...
import com.example.module_3_lesson_3_hw_1_compose.ui.theme.Module_3_Lesson_3_hw_1_ComposeTheme

class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContent {
            Module_3_Lesson_3_hw_1_ComposeTheme {
                Box(
